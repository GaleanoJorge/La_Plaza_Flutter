...
//
//     final bazzaio = bazzaioFromJson(jsonString);

import 'package:meta/meta.dart';
import 'dart:convert';

Bazzaio bazzaioFromJson(String str) => Bazzaio.fromJson(json.decode(str));

String bazzaioToJson(Bazzaio data) => json.encode(data.toJson());
...
class Bazzaio {
  ...
  factory Bazzaio.fromJson(Map<String, dynamic> json) => Bazzaio(
        code: json["code"],
